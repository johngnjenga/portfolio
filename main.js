...
// Remove context menu prevention for images
document.addEventListener("contextmenu", function (e) {
    if (e.target.nodeName === "IMG") {
        return; // Allow context menu for images
    }
}, false);
...
// Click outside image to zoom out
document.addEventListener('click', function (e) {
    const zoomedImage = document.querySelector('img[style*="scale(2)"]');
